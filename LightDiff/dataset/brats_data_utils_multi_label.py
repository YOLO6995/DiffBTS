...
class PretrainDataset(Dataset):
    ...
    def read_data(self, data_path):
        image_paths = data_path["image"]
        seg_path = data_path["label"]
...
def get_loader_brats(data_dir, data_json=None, fold=0):
    train_files, test_files = datafold_read(datalist=data_json, basedir=data_dir, fold=fold)
    val_files = test_files[:int(len(test_files))]
